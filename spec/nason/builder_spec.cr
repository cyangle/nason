...
private def assert_built(expected, *, file = __FILE__, line = __LINE__)
  assert_prints NASON.build { |json| with json yield json }, expected, file: file, line: line
end
...
describe NASON::Builder do
  ...
  it "errors on nan" do
    json = NASON::Builder.new(IO::Memory.new)
    json.start_document
  ...
  it "errors if writing before document start" do
    json = NASON::Builder.new(IO::Memory.new)
    expect_raises NASON::Error, "Write before start_document" do
      json.number(1)
    end
  end
  ...
  it "errors if writing two scalars" do
    ...
    json.start_document
    json.number(1)
    expect_raises NASON::Error, "Write past end_document and before start_document" do
      json.number(2)
    end
  end
  ...
  it "raises if nothing written" do
    json = NASON::Builder.new(IO::Memory.new)
    json.start_document
    expect_raises NASON::Error, "Empty NASON" do
      json.end_document
    end
  end
  ...
  it "raises if array is left open" do
    ...
    json.start_document
    json.start_array
    expect_raises NASON::Error, "Unterminated NASON array" do
      json.end_document
    end
  end
  ...
  it "raises if object is left open" do
    ...
    json.start_document
    json.start_object
    expect_raises NASON::Error, "Unterminated NASON object" do
      json.end_document
    end
  end
  ...
  it "errors on max nesting (array)" do
    ...
    expect_raises(NASON::Error, "Nesting of 4 is too deep") do
      builder.start_array
    end
  end

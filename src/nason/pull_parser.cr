...
#
# You must be careful when calling those methods, as they move forward into the NASON input you are pulling.
...
class NASON::PullParser
  ...
  {% for type in [Int8, Int16, Int32, Int64, UInt8, UInt16, UInt32] %}
    ...
    rescue NASON::ParseException | OverflowError
      nil
    end
  {% end %}
  ...
  rescue NASON::ParseException | ArgumentError
    nil
  end
  ...
  rescue exc : NASON::ParseException | ArgumentError
    nil
  end
